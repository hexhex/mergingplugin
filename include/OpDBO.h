...
namespace dlvhex{
	namespace merging{
		namespace plugin{
			/**
			 * This class implements distance-based operators.
			 * Usage:
			 * &operator["dbo", A, K](A)
			 ...
			 *
			 *	K(bsdiatance, p)	... Sets the costs for a certain kind of difference between an individual's opinion and the aggregated one.
